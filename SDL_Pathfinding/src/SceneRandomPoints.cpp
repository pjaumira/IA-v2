...
SceneRandomPoints::SceneRandomPoints()
{
	draw_grid = true;
...
void SceneRandomPoints::update(float dtime, SDL_Event *event)
{
...
const char* SceneRandomPoints::getTitle()
{
	return "SDL Steering Behaviors :: PathFinding1 Demo";
}

void SceneRandomPoints::drawMaze()
{
	if (draw_grid)
	{
...
void SceneRandomPoints::drawCoin()
{
...
void SceneRandomPoints::initMaze()
{
...
bool SceneRandomPoints::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D SceneRandomPoints::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D SceneRandomPoints::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x / CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool SceneRandomPoints::isValidCell(Vector2D cell)
{
