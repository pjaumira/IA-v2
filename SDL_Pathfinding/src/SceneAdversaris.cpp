...
SceneAdversaris::SceneAdversaris()
{
	draw_grid = true;
...
void SceneAdversaris::update(float dtime, SDL_Event *event)
{
...
const char* SceneAdversaris::getTitle()
{
	return "SDL Steering Behaviors :: PathFinding1 Demo";
}

void SceneAdversaris::drawMaze()
{
	if (draw_grid)
	{
...
bool SceneAdversaris::loadTextures(char* filename_bg, char* filename_coin)
{
...
Vector2D SceneAdversaris::cell2pix(Vector2D cell)
{
	int offset = CELL_SIZE / 2;
	return Vector2D(cell.x*CELL_SIZE + offset, cell.y*CELL_SIZE + offset);
}

Vector2D SceneAdversaris::pix2cell(Vector2D pix)
{
	return Vector2D((float)((int)pix.x / CELL_SIZE), (float)((int)pix.y / CELL_SIZE));
}

bool SceneAdversaris::isValidCell(Vector2D cell)
{
